  ...
  return (
    <section className="relative h-screen w-full overflow-hidden" style={{ background: '#07020a' }}>
      ...
      <div className="relative z-10 flex flex-col h-full pt-20 sm:pt-24 md:pt-[80px] pb-8 sm:pb-10 md:pb-12 px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        {/* Footer nav */}
        <SectionNav active="skills" onNavigate={onNavigate} />
      </div>
    </section>
  );
}
...
function SectionNav({ active, onNavigate }: { active: SectionId; onNavigate: (id: SectionId) => void }) {
  ...
  return (
    <motion.div className="mt-4 sm:mt-5 md:mt-6 pt-4 sm:pt-5 flex flex-wrap items-center justify-between gap-2 shrink-0">
